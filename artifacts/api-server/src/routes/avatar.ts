...
export const BUILT_IN_AVATARS = [
  {
    key: "storm-default",
    name: "Storm",
    tagline: "Energetic anime-style host",
    description: "Lively and expressive. Best for Hype, Friendly, and Funny personas.",
    style: "Anime",
    accentColor: "#8b5cf6",
    personalities: ["friendly", "funny", "motivator"],
  },
  {
    key: "storm-serious",
    name: "Atlas",
    tagline: "Professional realistic host",
    description: "Confident and composed. Best for Serious and Battle personas.",
    style: "Realistic",
    accentColor: "#3b82f6",
    personalities: ["serious", "battle"],
  },
  {
    key: "storm-cute",
    name: "Mochi",
    tagline: "Chibi-style host",
    description: "Adorable and expressive. Best for Funny and Troll personas.",
    style: "Chibi",
    accentColor: "#ec4899",
    personalities: ["funny", "troll"],
  },
];
