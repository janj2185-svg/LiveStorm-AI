...
import { LayoutDashboard, Bot, BarChart2, Settings, Monitor, Gift, Users, Zap, TrendingUp, Heart, MessageSquare } from "lucide-react";

const FONT = "Sora";
const FONT_URL = "https://fonts.googleapis.com/css2?family=Sora:wght@300;400;500;600;700;800;900&display=swap";
    ...
    <div style={{ fontFamily: `'${FONT}', sans-serif`, background: "#0b0a1a", minHeight: "100vh", display: "flex", color: "#e8e6f0" }}>
      ...
      <main style={{ flex: 1, padding: "28px 28px", overflow: "hidden" }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 900, color: "#fff", letterSpacing: "-0.025em", margin: 0 }}>Dashboard</h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
          {STATS.map((s) => (
            <div key={s.label} style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: "14px 16px" }}>
              ...
              <div style={{ fontSize: 22, fontWeight: 900, color: "#fff", letterSpacing: "-0.03em", fontVariantNumeric: "tabular-nums" }}>{s.value}</div>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          <button style={{ background: "linear-gradient(135deg,#7c3aed,#4f46e5)", border: "none", borderRadius: 12, padding: "10px 20px", color: "#fff", fontSize: 13, fontWeight: 600, fontFamily: `'${FONT}', sans-serif`, cursor: "pointer", letterSpacing: "-0.01em" }}>
            Start Session
          </button>
        ...
        <div style={{ background: "rgba(124,58,237,0.06)", border: "1px solid rgba(124,58,237,0.2)", borderRadius: 14, padding: "14px 16px" }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Live Activity Feed</div>
